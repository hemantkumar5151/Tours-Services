...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVtYW50NTE1MSIsImEiOiJja2p4YWNjZWMwcTdiMm5sc3hycnVlaDhjIn0.kv1hqwV7fED5_PVwcrD2wA';
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl).concat(api, "/users/signup"),
              data: {
                name: name,
                email: email,
                password: password,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "".concat(baseUrl).concat(api, "/users/logout")
            });
...
var baseUrl = 'http://localhost:5000';
var api = '/api/v1'; // type is either 'password' or 'data'
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? "".concat(baseUrl).concat(api, "/users/updateMyPassword") : "".concat(baseUrl).concat(api, "/users/updateMe");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_cahReNKvg46Mkrj75Mn8l26h00iETVckaO');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)("".concat(baseUrl).concat(api, "/bookings/checkout-session/").concat(tourId));
...
var paymentBtn = document.getElementById('book-tour'); // DELEGATION
...
if (paymentBtn) {
  paymentBtn.addEventListener('click', function (e) {
    ...
    var tourId = paymentBtn.getAttribute('data-tour-id');
    console.log(tourId);
